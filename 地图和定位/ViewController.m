...
- (void)initData {
    _dataArray = [[NSArray alloc] initWithObjects:@"MapKit（定位当前位置和加大头针）",@"CoreLocation(定位)",@"AppleMap", nil];
    _classArray = [[NSArray alloc] initWithObjects:@"MapKitViewController",@"CoreLocationViewController",@"", nil];
}
